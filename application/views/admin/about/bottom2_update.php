		...
		<div class="row">
			<div class="col-xl-6">
				<div class="card custom-card">
					...
					<form action="<?php echo base_url('about_bottom2_update_act/'.$a_bottom2['id']); ?>" method="post"
						  enctype="multipart/form-data">
						<div class="card-body">
							<div class="row mb-3">
								<label for="colFormLabel" class="col-sm-2 col-form-label">Name</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="name" id="colFormLabel" value="<?php echo $a_bottom2['name'] ?>" placeholder="Header Başlıq...">
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" name="num" id="num" value="<?php echo $a_bottom2['num'] ?>" placeholder="Number ...">
								</div>
							</div>
						</div>
